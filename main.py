...
class PDFSorterApp:
    ...
    def create_widgets(self):
        ...
        tk.Radiobutton(frame_sort, text="Rosnąco", variable=self.sort_order, value="ascending").pack(
            side='left')
        tk.Radiobutton(frame_sort, text="Malejąco", variable=self.sort_order, value="descending").pack(
            side='left')
    ...
    def process_documents(self):
        ...
        try:
            ...
            # Zapis
            output_filename = pdf_file.replace(".pdf", "_Sorted.pdf")
